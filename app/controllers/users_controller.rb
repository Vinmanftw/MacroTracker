class UsersController < ApplicationController
    ...
    def update_macro_params
        ...
        params.require(:user).permit(:weight,:height,:body_fat,:is_bulking,:goal_protein,:goal_carbs,:goal_fat,:goal_calories,:goal_weight,:goal_body_fat,:goal_lb_change_per_week)
    end
